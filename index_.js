...
server.on("request", (request, response) => {
  ...
  if (parsedUrl.pathname == "/ver") {
    ...
    // if(parsedUrl.path == "/filtragem?valorMinimo =" + parsedUrl.query.valorMinimo) ++ "&valorMinimo=" + parsedUrl.query.valorMaximo)) {
    //   let nomeArquivos = fs.readdirSync(__dirname + "/dados/inquilinos");
