...
server.on("request", (request, response) => {
  ...
  if (parsedUrl.pathname == "/ver") {
    ///////////////////////////////////////////
    // SE A URL TIVER UM PARAMETRO ID, CARREGUE O JSON E PRINTE NA TELA
  ...
  // SE A URL FOR /CRIAR
    ...
    //////////////////////////////
    // SE TIVER UM PARAMETRO nome NA URL, CRIE UM JSON COM OS DADOS ENVIADOS, E PRINTE O RESULTADO NA TELA
    ...
    //////////////////////////////////////////
    // CASO NAO TENHA NENHUM PARAMETRO nome NA URL, CARREGUE O ARQUIVO novo-inquilino.html E PRINTE NA TELA
    else {
